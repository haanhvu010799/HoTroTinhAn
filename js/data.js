...
const defaultOffenses = {
  ...
  level2: [
    ...
    { id: "l2_5", name: "Tấn công gây thương tích chưa nghiêm trọng ", time: 30 },
    { id: "l2_6", name: "Chống đối người thi hành công vụ ", time: 30 },
    { id: "l2_7", name: "Có hành động, lời lẽ xúc phạm đến người khác ", time: 30 },    
    { id: "l2_8", name: "Nhập cư trái phép", time: 30 },
    { id: "l2_9", name: "Tàng trữ chất cấm trái phép", time: 30 },
    { id: "l2_10", name: "Vu khống người khác", time: 30 },
    { id: "l2_11", name: "Gây rối trước khu vực trụ sở cơ quan Nhà Nước ", time: 30 },
    { id: "l2_12", name: "Xâm nhập trụ sở, nơi làm việc của Ban ngành Nhà Nước ", time: 30 },
  ],
  level3: [
